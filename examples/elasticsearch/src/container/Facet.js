...
import { MultiCheckboxFacet } from "../view";
import { helpers } from "@elastic/search-ui";
import { Facet, Filter, FilterType } from "@elastic/react-search-ui/es/types";
import { accentFold } from "@elastic/react-search-ui/es/helpers";
import { withSearch } from "@elastic/react-search-ui/es";
  ...
  _createClass(FacetContainer, [{
    ...
    value: function render() {
      ...
      var _this$state = this.state,
          ...
          originShow = _this$state.originShow,
      ...
      return View(_objectSpread({
        ...
        onLessClick: this.handleClickMore.bind(this, originShow),
